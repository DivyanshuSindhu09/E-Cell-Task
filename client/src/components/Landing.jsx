  ...
  return loading ? <Loading/> : (
    <>
        <section className='max-h-screen overflow-y-auto no-scrollbar'>
                <header>
            <nav className='w-full font-[absans] z-2 sticky flex-col gap-4 md:flex-row lg:flex-row pt-6 flex items-center justify-between px-7 py-2'>
                <span className='text-4xl text-white font-[acma]'>StartupHub</span>
                <div className='w-full lg:w-[35%] md:w-[35%] flex gap-2 border-2 border-white rounded-lg'>
                <input 
                id='input' 
                type="text"
                value={input}
